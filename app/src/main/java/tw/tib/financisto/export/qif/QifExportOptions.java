...
public class QifExportOptions {
    ...
    public QifExportOptions(Currency currency, String dateFormat, long[] selectedAccounts, WhereFilter filter, boolean uploadToGDrive) {
    ...
    public static QifExportOptions fromIntent(Intent data) {
        ...
        return new QifExportOptions(currency, dateFormat, selectedAccounts, filter, uploadToGDrive);
    }
